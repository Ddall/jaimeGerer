...
namespace App\Service\Emailing;
...
class MailgunService{
    ...
    public function __construct(string $apiKey = '', string $domain = '', EntityManagerInterface $em)
    {
        $this->apiKey = $apiKey;
        $this->domain = $domain;
        $this->em = $em;
    ...
    public function saveWebhookEvent($eventData){
        ...
        try{
            $contactRepository = $this->em->getRepository('App:CRM\Contact');
            $campagneContactRepository = $this->em->getRepository('App:Emailing\CampagneContact');
