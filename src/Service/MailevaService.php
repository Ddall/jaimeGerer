...
class MailevaService {
	...
	public function pieceJointeDeService($path, $fileName, $facture, $numRelance, $recommande){
	   	...
	   	try{
		   	...
		   	$xml_sender_id->value =  $this->user->getCompany()->getNom();
		   	...
		   	$xml_address_line_1 = $xml->createElement("com:AddressLine1", $this->user->getCompany()->getNom());
		   	$xml_address_lines->appendChild($xml_address_line_1);

		   	$xml_address_line_2 = $xml->createElement("com:AddressLine2", $this->user->getFirstname().' '.$this->user->getLastname());
		   	$xml_address_lines->appendChild($xml_address_line_2);

		   	$xml_address_line_4 = $xml->createElement("com:AddressLine4", $this->user->getCompany()->getAdresse());
		   	$xml_address_lines->appendChild($xml_address_line_4);

		   	$codePostal = str_replace(' ','', $this->user->getCompany()->getCodePostal());
		   	$xml_address_line_6 = $xml->createElement("com:AddressLine6", $codePostal.' '.$this->user->getCompany()->getVille());
		   	$xml_address_lines->appendChild($xml_address_line_6);

		   	$xml_paper_address->appendChild($xml_address_lines);

		   	$xml_country = $xml->createElement("com:Country", $this->user->getCompany()->getPays());
		   	$xml_paper_address->appendChild($xml_country);
		   	...
		   	$xml_email = $xml->createElement("spec:Email", $this->user->getEmail());
		   	...
		   	$xml_email_lre = $xml->createElement("spec:Email", $this->user->getEmail());
