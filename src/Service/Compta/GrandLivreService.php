...
class GrandLivreService  {
  ...
  private function creerGrandLignePourCompte($compteComptable, $startDate, $endDate){
    ...
    $repoJournalVente = $this->em->getRepository('App:Compta\JournalVente');
    ...
    $repoJournalAchat = $this->em->getRepository('App:Compta\JournalAchat');
    ...
    $repoJournalBanque = $this->em->getRepository('App:Compta\JournalBanque');
    ...
    $repoOperationDiverse = $this->em->getRepository('App:Compta\OperationDiverse');
