...
class FECService {
    ...
    protected $separator;
  	...
  	public function __construct(string $rootDir = '', EntityManagerInterface $em, UtilsService $utilsService)
  	{
   		$this->em = $em;
    ...
    public function createFECFile($company, $year){
        ...
        $compteBancaireRepo = $this->em->getRepository('App:Compta\CompteBancaire');
    ...
    public function getFECData($company, $year){
        ...
        $journalVenteRepo = $this->em->getRepository('App:Compta\JournalVente');
        $journalAchatRepo = $this->em->getRepository('App:Compta\JournalAchat');
        $journalBanqueRepo = $this->em->getRepository('App:Compta\JournalBanque');
        $journalODRepo = $this->em->getRepository('App:Compta\OperationDiverse');
