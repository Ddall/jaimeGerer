...
use App\Entity\Compta\PrevTreso;
use App\Service\UtilsService;
use Doctrine\ORM\EntityManagerInterface;

class TableauTresorerieService {
  ...
  public function calculTresorerieAccurate($compteBancaire, $year){
    ...
    $soldeRepo = $this->em->getRepository('App:Compta\SoldeCompteBancaire');
  ...
  public function calculTresoreriePrevisonnelle($compteBancaire, $year){
    ...
    $prevTresoRepo = $this->em->getRepository('App:Compta\PrevTreso');
