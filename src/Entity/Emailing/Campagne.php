 ...
 * @ORM\Entity(repositoryClass="App\Entity\Emailing\CampagneRepository")
 */
class Campagne
{
    /**
    ...
    /**
    *
    * @ORM\OneToMany(targetEntity="App\Entity\Emailing\CampagneContact", mappedBy="campagne", cascade={"persist", "remove"}, orphanRemoval=true)
    *
    */
