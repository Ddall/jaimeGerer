 ...
 * @ORM\Entity(repositoryClass="App\Entity\Emailing\CampagneContactRepository")
 */
class CampagneContact
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Emailing\Campagne", inversedBy="campagneContacts", cascade={"persist"})
     * @ORM\JoinColumn(nullable=false, onDelete="CASCADE")
     */
    private $campagne;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\CRM\Contact", inversedBy="campagneContacts")
     * @ORM\JoinColumn(nullable=false, onDelete="CASCADE")
     */
    private $contact;
     ...
     * Set campagne
     *
     * @param \App\Entity\Emailing\Campagne $campagne
     * @return CampagneContact
     */
    public function setCampagne(\App\Entity\Emailing\Campagne $campagne)
    {
     ...
     * Get campagne
     *
     * @return \App\Entity\Emailing\Campagne
     */
     ...
     * @return CampagneContact
     */
    public function setContact(\App\Entity\CRM\Contact $contact)
    {
