 ...
 * Contact
 *
 * @ORM\Entity(repositoryClass="App\Entity\CRM\ContactRepository")
...
class Contact
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\CRM\Compte", inversedBy="contacts")
    ...
    /**
     *
     * @ORM\OneToMany(targetEntity="App\Entity\CRM\PriseContact", mappedBy="contact", cascade={"persist", "remove"}, orphanRemoval=true)
    ...
    /**
    *
    * @ORM\OneToMany(targetEntity="App\Entity\Emailing\CampagneContact", mappedBy="contact")
    *
    */
     ...
     * @var DocumentPrix[]
     *
     * @ORM\OneToMany(targetEntity="App\Entity\CRM\DocumentPrix", mappedBy="contact")
     */
     ...
     * @var Opportunite[]
     * 
     * @ORM\OneToMany(targetEntity="App\Entity\CRM\Opportunite", mappedBy="contact")
     */
     ...
     * Set reseau
     *
     * @param \App\Entity\Settings $reseau
     * @return Contact
     */
    public function setReseau(\App\Entity\Settings $reseau)
    {
        $this->reseau = $reseau;
     ...
     * @return Contact
     */
    public function setOrigine(\App\Entity\Settings $origine)
    {
     ...
     * Add settings
     *
     * @param \App\Entity\Settings $setting
     * @return Contact
     */
    public function addSetting(\App\Entity\Settings $setting)
    {
    	$found = false;
     ...
     * Add priseContacts
     *
     * @param \App\Entity\CRM\PriseContact $priseContacts
     * @return Contact
     */
    public function addPriseContact(\App\Entity\CRM\PriseContact $priseContacts)
    {
     ...
     * @param \App\Entity\CRM\PriseContact $priseContacts
     */
    public function removePriseContact(\App\Entity\CRM\PriseContact $priseContacts)
    {
     ...
     *
     * @param \App\Entity\Emailing\CampagneContact $campagneContacts
     * @return Contact
     */
    public function addCampagneContact(\App\Entity\Emailing\CampagneContact $campagneContacts)
    {
     ...
     * @param \App\Entity\Emailing\CampagneContact $campagneContacts
     */
    public function removeCampagneContact(\App\Entity\Emailing\CampagneContact $campagneContacts)
    {
     ...
     * Add documentsPrix
     *
     * @param \App\Entity\CRM\DocumentPrix $documentsPrix
     * @return Contact
     */
    public function addDocumentsPrix(\App\Entity\CRM\DocumentPrix $documentsPrix)
    {
     ...
     * @param \App\Entity\CRM\DocumentPrix $documentsPrix
     */
    public function removeDocumentsPrix(\App\Entity\CRM\DocumentPrix $documentsPrix)
    {
     ...
     * Add opportunites
     *
     * @param \App\Entity\CRM\Opportunite $opportunites
     * @return Contact
     */
    public function addOpportunite(\App\Entity\CRM\Opportunite $opportunites)
    {
     ...
     * @param \App\Entity\CRM\Opportunite $opportunites
     */
    public function removeOpportunite(\App\Entity\CRM\Opportunite $opportunites)
    {
