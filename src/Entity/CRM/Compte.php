 ...
 * Compte
 *
 * @ORM\Entity(repositoryClass="App\Entity\CRM\CompteRepository")
...
class Compte
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\CRM\Compte", inversedBy="compteEnfants")
     * @ORM\JoinColumn(nullable=true)
     */
    private $compteParent;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\CRM\Compte", mappedBy="compteParent")
     */
    ...
    /**
    * @ORM\OneToMany(targetEntity="App\Entity\CRM\DocumentPrix", mappedBy="compte", cascade={"persist", "remove"})
    */    
    private $documentPrixs;

    /**
    * @ORM\OneToMany(targetEntity="App\Entity\CRM\Opportunite", mappedBy="compte", cascade={"persist", "remove"})
    */    
    private $opportunites;

    /**
    * @ORM\OneToMany(targetEntity="App\Entity\CRM\Contact", mappedBy="compte", cascade={"persist", "remove"})
    */    
    private $contacts;

    /**
    * @ORM\OneToMany(targetEntity="App\Entity\Compta\Depense", mappedBy="compte", cascade={"persist", "remove"})
    */ 
    private $depenses;
     ...
     *
     * @param \App\Entity\Compta\CompteComptable $compteComptableClient
     * @return Compte
     */
    public function setCompteComptableClient(\App\Entity\Compta\CompteComptable $compteComptableClient)
    {
     ...
     *
     * @param \App\Entity\Compta\CompteComptable $compteComptableFournisseur
     * @return Compte
     */
    public function setCompteComptableFournisseur(\App\Entity\Compta\CompteComptable $compteComptableFournisseur)
    {
     ...
     * Set secteurActivite
     *
     * @param \App\Entity\Settings $secteurActivite
     * @return Compte
     */
    public function setSecteurActivite(\App\Entity\Settings $secteurActivite = null)
    {
     ...
     * @return Compte
     */
    public function addDocumentPrix(\App\Entity\CRM\DocumentPrix $documentPrix)
    {
     ...
     * @param \App\Entity\CRM\DocumentPrix $documentPrix
     */
    public function removeDocumentPrix(\App\Entity\CRM\DocumentPrix $documentPrix)
    {
     ...
     * @return Compte
     */
    public function addOpportunite(\App\Entity\CRM\Opportunite $opportunite)
    {
     ...
     * @param \App\Entity\CRM\Opportunite $opportunite
     */
    public function removeOpportunite(\App\Entity\CRM\Opportunite $opportunite)
    {
     ...
     * @return Compte
     */
    public function addContact(\App\Entity\CRM\Contact $contact)
    {
     ...
     * @param \App\Entity\CRM\Contact $contact
     */
    public function removeContact(\App\Entity\CRM\Contact $contact)
    {
     ...
     * @return Compte
     */
    public function addDepense(\App\Entity\Compta\Depense $depense)
    {
     ...
     * @param \App\Entity\Compta\Depense $depense
     */
    public function removeDepense(\App\Entity\Compta\Depense $depense)
    {
     ...
     * Add compteEnfants
     *
     * @param \App\Entity\CRM\Compte $compteEnfants
     * @return Compte
     */
    public function addCompteEnfant(\App\Entity\CRM\Compte $compteEnfants)
    {
     ...
     * @param \App\Entity\CRM\Compte $compteEnfants
     */
    public function removeCompteEnfant(\App\Entity\CRM\Compte $compteEnfants)
    {
