 ...
 * @ORM\Entity(repositoryClass="App\Entity\CRM\FraisRepository")
 */
class Frais
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\CRM\Opportunite", inversedBy="frais")
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\CRM\Produit", mappedBy="frais")
     ...
     * @return Frais
     */
    public function setActionCommerciale(\App\Entity\CRM\Opportunite $actionCommerciale = null)
    {
