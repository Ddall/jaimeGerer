...
class RapportFilter
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\CRM\Rapport", inversedBy="filtres")
     * @ORM\JoinColumn(nullable=true, onDelete="CASCADE")
     */
    private $rapport;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\CRM\Prospection")
     * @ORM\JoinColumn(nullable=true, onDelete="CASCADE")
     */
    private $prospection;
     ...
     * Set rapport
     *
     * @param \App\Entity\CRM\Rapport $rapport
     * @return RapportFilter
     */
    public function setRapport(\App\Entity\CRM\Rapport $rapport)
    {
     ...
     * Set prospection
     *3
     * @param \App\Entity\CRM\Prospection $prospection
     * @return RapportFilter
     */
    public function setProspection(\App\Entity\CRM\Prospection $prospection)
    {
     ...
     * Get prospection
     *
     * @return \App\Entity\CRM\Prospection
     */
