 ...
 * Opportunite
 *
 * @ORM\Entity(repositoryClass="App\Entity\CRM\OpportuniteRepository")
...
class Opportunite
{
    ...
    */
    ...
    /**
    * @ORM\ManyToMany(targetEntity="App\Entity\Settings", cascade={"persist"})
    * @ORM\JoinColumn(nullable=true, onDelete="SET NULL")
    */
    private $settings;
    ...
    /**
    * @ORM\ManyToOne(targetEntity="App\Entity\CRM\Compte", inversedBy="opportunites" )
    * @ORM\JoinColumn(nullable=false)
    * @Assert\NotBlank()
    */
    private $compte;
    ...
    /**
    * @ORM\ManyToOne(targetEntity="App\Entity\CRM\Contact", inversedBy="opportunites")
    * @ORM\JoinColumn(nullable=true)
    */
    private $contact;
    ...
    /**
    *
    * @ORM\OneToMany(targetEntity="App\Entity\CRM\OpportuniteRepartition", mappedBy="opportunite", cascade={"persist", "remove"}, orphanRemoval=true)
    ...
    */
    ...
    /**
    *
    * @ORM\OneToMany(targetEntity="App\Entity\CRM\OpportuniteSousTraitance", mappedBy="opportunite", cascade={"persist", "remove"}, orphanRemoval=true)
    *
    */
    ...
    */
    ...
    /**
    * @ORM\OneToOne(targetEntity="App\Entity\CRM\DocumentPrix", inversedBy="opportunite")
    * @ORM\JoinColumn(nullable=true)
    */
    private $devis;
    ...
    */
    ...
    /**
    *
    * @ORM\OneToMany(targetEntity="App\Entity\CRM\BonCommande", mappedBy="actionCommerciale", cascade={"persist", "remove"}, orphanRemoval=true)
    *
    */
    ...
    */
    ...
    private $fichier;
     ...
     /**
     * @ORM\OneToMany(targetEntity="App\Entity\CRM\PlanPaiement", mappedBy="actionCommerciale", cascade={"persist", "remove"}, orphanRemoval=true)
     * @ORM\JoinColumn(nullable=true)
     * @ORM\OrderBy({"date" = "ASC"})
     */
    ...
    /**
    *
    * @ORM\OneToMany(targetEntity="App\Entity\CRM\Frais", mappedBy="actionCommerciale", cascade={"persist", "remove"}, orphanRemoval=true)
    *
    */
    private $frais;
    ...
    /**
    *
    * @ORM\OneToMany(targetEntity="App\Entity\NDF\Recu", mappedBy="actionCommerciale", cascade={"persist", "remove"}, orphanRemoval=true)
    *
    */
    private $recus;
    ...
    /**
    *
    * @ORM\OneToMany(targetEntity="App\Entity\TimeTracker\Temps", mappedBy="actionCommerciale", cascade={"persist", "remove"}, orphanRemoval=true)
    * @ORM\OrderBy({"date" = "ASC"})
    *
    */
    private $temps;
    ...
    */
	 ...
	 * @return Contact
	 */
	public function addSetting(\App\Entity\Settings $settings)
	{
	 ...
	 * @param \App\Entity\Settings $settings
	 */
	public function removeSetting(\App\Entity\Settings $settings)
	{
     ...
     * Set probabilite
     *
     * @param \App\Entity\Settings $probabilite
     * @return Opportunite
     */
    public function setProbabilite(\App\Entity\Settings $probabilite = null)
    {
     ...
     * Set origine
     *
     * @param \App\Entity\Settings $origine
     * @return Opportunite
     */
    public function setOrigine(\App\Entity\Settings $origine = null)
    {
     ...
     *
     * @param \App\Entity\CRM\OpportuniteRepartition $opportuniteRepartitions
     * @return Opportunite
     */
    public function addOpportuniteRepartition(\App\Entity\CRM\OpportuniteRepartition $opportuniteRepartitions)
    {
     ...
     * @param \App\Entity\CRM\OpportuniteRepartition $opportuniteRepartitions
     */
    public function removeOpportuniteRepartition(\App\Entity\CRM\OpportuniteRepartition $opportuniteRepartitions)
    {
     ...
     *
     * @param \App\Entity\CRM\OpportuniteSousTraitance $opportuniteSousTraitances
     * @return Opportunite
     */
    public function addOpportuniteSousTraitance(\App\Entity\CRM\OpportuniteSousTraitance $opportuniteSousTraitances)
    {
     ...
     * @param \App\Entity\CRM\OpportuniteSousTraitance $opportuniteSousTraitances
     */
    public function removeOpportuniteSousTraitance(\App\Entity\CRM\OpportuniteSousTraitance $opportuniteSousTraitances)
    {
     ...
     * Add bonsCommande
     *
     * @param \App\Entity\CRM\BonCommande $bonsCommande
     * @return Opportunite
     */
    public function addBonsCommande(\App\Entity\CRM\BonCommande $bonsCommande)
    {
     ...
     * @param \App\Entity\CRM\BonCommande $bonsCommande
     */
    public function removeBonsCommande(\App\Entity\CRM\BonCommande $bonsCommande)
    {
     ...
     * Set userCompetCom
     *
     * @param \App\Entity\User $userCompetCom
     * @return Opportunite
     */
    public function setUserCompetCom(\App\Entity\User $userCompetCom)
    {
     ...
     * Add planPaiements
     *
     * @param \App\Entity\CRM\PlanPaiement $planPaiements
     * @return Opportunite
     */
    public function addPlanPaiement(\App\Entity\CRM\PlanPaiement $planPaiements)
    {
     ...
     * @param \App\Entity\CRM\PlanPaiement $planPaiements
     */
    public function removePlanPaiement(\App\Entity\CRM\PlanPaiement $planPaiements)
    {
     ...
     * Add frais
     *
     * @param \App\Entity\CRM\Frais $frais
     * @return Opportunite
     */
    public function addFrai(\App\Entity\CRM\Frais $frais)
    {
     ...
     * @param \App\Entity\CRM\Frais $frais
     */
    public function removeFrai(\App\Entity\CRM\Frais $frais)
    {
     ...
     * Add recus
     *
     * @param \App\Entity\NDF\Recu $recus
     * @return Opportunite
     */
    public function addRecus(\App\Entity\NDF\Recu $recus)
    {
        $this->recus[] = $recus;
     ...
     * @param \App\Entity\NDF\Recu $recus
     */
    public function removeRecus(\App\Entity\NDF\Recu $recus)
    {
     ...
     * Add temps
     *
     * @param \App\Entity\TimeTracker\Temps $temps
     * @return Opportunite
     */
    public function addTemp(\App\Entity\TimeTracker\Temps $temps)
    {
        $this->temps[] = $temps;
     ...
     * @param \App\Entity\TimeTracker\Temps $temps
     */
    public function removeTemp(\App\Entity\TimeTracker\Temps $temps)
    {
     ...
     * @return Opportunite
     */
    public function setDevis(\App\Entity\CRM\DocumentPrix $devis = null)
    {
        $this->devis = $devis;
