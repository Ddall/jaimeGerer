 ...
 * @ORM\Entity(repositoryClass="App\Entity\CRM\RapportRepository")
 */
class Rapport
{
    /**
    ...
    /**
     *
     * @ORM\OneToMany(targetEntity="App\Entity\CRM\RapportFilter", mappedBy="rapport", cascade={"persist", "remove"}, orphanRemoval=true)
     *
     */
    private $filtres;
     ...
     * Add filtres
     *
     * @param \App\Entity\CRM\RapportFilter $filtres
     * @return Rapport
     */
    public function addFiltre(\App\Entity\CRM\RapportFilter $filtres)
    {
     ...
     * @param \App\Entity\CRM\RapportFilter $filtres
     */
    public function removeFiltre(\App\Entity\CRM\RapportFilter $filtres)
    {
