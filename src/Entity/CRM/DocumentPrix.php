 ...
 * @ORM\Entity(repositoryClass="App\Entity\CRM\DocumentPrixRepository")
 */
class DocumentPrix
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\CRM\Compte", inversedBy="documentPrixs")
     * @ORM\JoinColumn(nullable=false)
     * @Assert\NotBlank()
     */
    private $compte;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\CRM\Contact", inversedBy="documentsPrix")
     * @ORM\JoinColumn(nullable=true)
     */
    private $contact;
    ...
    /**
    *
    * @ORM\OneToMany(targetEntity="App\Entity\CRM\Produit", mappedBy="documentPrix", cascade={"persist", "remove"}, orphanRemoval=true)
    *
    */
    private $produits;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Compta\Rapprochement", mappedBy="facture")
     */
    private $rapprochements;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Compta\Avoir", mappedBy="facture")
     */
    private $avoirs;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Compta\Relance", mappedBy="facture")
     */
    private $relances;
    ...
    /**
    * @ORM\OneToOne(targetEntity="App\Entity\CRM\Opportunite", mappedBy="devis")
    * @ORM\JoinColumn(nullable=true)
    */
    private $opportunite;
    ...
    /**
    * @ORM\ManyToOne(targetEntity="App\Entity\CRM\BonCommande", inversedBy="factures")
    * @ORM\JoinColumn(nullable=true, onDelete="SET NULL")
    */
    private $bonCommande;

    /**
    * @ORM\OneToMany(targetEntity="App\Entity\Compta\JournalVente", mappedBy="facture", cascade={"remove"}, orphanRemoval=true)
    */
   ...
   */
     ...
     * Set compte
     *
     * @param \App\Entity\CRM\Compte $compte
     * @return DocumentPrix
     */
     ...
     * Add produits
     *
     * @param \App:CRM\Produit $produit
     * @return DocumentPrix
     */
    public function addProduit(\App\Entity\CRM\Produit $produit)
    {
     ...
     * Remove produits
     *
     * @param \App:CRM\Produit $produits
     */
    public function removeProduit(\App\Entity\CRM\Produit $produits)
    {
	 ...
	 * @param \App\Entity\Compta\Rapprochement $rapprochements
	 */
	public function removeRapprochement(\App\Entity\Compta\Rapprochement $rapprochement)
	{
     ...
     * @return DocumentPrix
     */
    public function addAvoir(\App\Entity\Compta\Avoir $avoir)
    {
     ...
     * Remove avoirs
     *
     * @param \App\Entity\Compta\Avoir $avoirs
     */
    public function removeAvoir(\App\Entity\Compta\Avoir $avoirs)
    {
     ...
     * Add relance
     *
     * @param \App\Entity\Compta\Relance $relance
     * @return DocumentPrix
     */
    public function addRelance(\App\Entity\Compta\Relance $relance)
    {
     ...
     * @param \App\Entity\Compta\Relance $relance
     */
    public function removeRelance(\App\Entity\Compta\Relance $relance)
    {
     ...
     * @return DocumentPrix
     */
    public function setOpportunite(\App\Entity\CRM\Opportunite $opportunite = null)
    {
     ...
     * Set bonCommande
     *
     * @param \App\Entity\CRM\BonCommande $bonCommande
     * @return DocumentPrix
     */
    public function setBonCommande(\App\Entity\CRM\BonCommande $bonCommande = null)
    {
     ...
     * Get bonCommande
     *
     * @return \App\Entity\CRM\BonCommande
     */
