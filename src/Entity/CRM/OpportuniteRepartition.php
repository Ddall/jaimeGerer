 ...
 * @ORM\Entity(repositoryClass="App\Entity\CRM\OpportuniteRepartitionRepository")
 */
class OpportuniteRepartition
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\CRM\Opportunite", inversedBy="opportuniteRepartitions")
