...
class OpportuniteRepository extends EntityRepository
{
	...
	public function custom_count($company, $etat="ONGOING"){

			$result = $this->createQueryBuilder('o')
			->select('COUNT(o)')
			->leftJoin('App\Entity\CRM\Compte', 'co', 'WITH', 'co.id = o.compte')
	...
	public function createQueryAndGetResult($arr_filters, $company){
		...
		$index=0;
		$leftJoinProbabilite = false; //$settingsRepository = $em->getRepository('App:Settings');
		$SettingsRepository = $this->_em->getRepository('App:Settings');
		...
		$query->leftJoin('App\Entity\CRM\Compte', 'co', 'WITH', 'co.id = o.compte')
