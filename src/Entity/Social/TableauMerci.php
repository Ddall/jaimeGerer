 ...
 * @ORM\Entity(repositoryClass="App\Entity\Social\TableauMerciRepository")
 */
class TableauMerci
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Social\Merci", mappedBy="tableauMerci")
     ...
     * Add mercis
     *
     * @param \App\Entity\Social\Merci $mercis
     * @return TableauMerci
     */
    public function addMerci(\App\Entity\Social\Merci $mercis)
    {
        $this->mercis[] = $mercis;
     ...
     * @param \App\Entity\Social\Merci $mercis
     */
    public function removeMerci(\App\Entity\Social\Merci $mercis)
    {
