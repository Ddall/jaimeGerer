 ...
 * @ORM\Entity(repositoryClass="App\Entity\Compta\ChequeRepository")
 */
class Cheque
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Compta\RemiseCheque", inversedBy="cheques")
     * @ORM\JoinColumn(nullable=false, onDelete="CASCADE")
     */
    private $remiseCheque;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Compta\ChequePiece", mappedBy="cheque", cascade={"persist", "remove"}, orphanRemoval=true)
     */
    private $pieces;
     ...
     * @return Cheque
     */
    public function setRemiseCheque(\App\Entity\Compta\RemiseCheque $remiseCheque)
    {
     ...
     * Add pieces
     *
     * @param \App\Entity\Compta\ChequePiece $pieces
     * @return Cheque
     */
    public function addPiece(\App\Entity\Compta\ChequePiece $pieces)
    {
        $this->pieces[] = $pieces;
     ...
     * @param \App\Entity\Compta\ChequePiece $pieces
     */
    public function removePiece(\App\Entity\Compta\ChequePiece $pieces)
    {
    ...
    public function getMontant(){
    	...
    	foreach($this->pieces as $piece){
    		if($piece->getFacture() != null){
    			...
    			$montant+=$piece->getOperationDiverse()->getCredit();
    		}
    	}
    	return $montant;
    }
