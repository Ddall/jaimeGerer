 ...
 * @ORM\Entity(repositoryClass="App\Entity\Compta\MouvementBancaireRepository")
 */
class MouvementBancaire
{
    ...
    /**
    * @ORM\OneToMany(targetEntity="App\Entity\Compta\Rapprochement", mappedBy="mouvementBancaire")
    */
