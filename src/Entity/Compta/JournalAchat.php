 ...
 * @ORM\Entity(repositoryClass="App\Entity\Compta\JournalAchatRepository")
 */
class JournalAchat
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Compta\CompteComptable", inversedBy="journalAchats")
     * @ORM\JoinColumn(nullable=false)
     */
    private $compteComptable;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Compta\Depense", inversedBy="journalAchats", cascade={"persist"})
     * @ORM\JoinColumn(nullable=true, unique=false)
     */
    private $depense;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Compta\Avoir", inversedBy="journalAchats", cascade={"persist"})
     * @ORM\JoinColumn(nullable=true, unique=false)
     */
    private $avoir;
