...
class AvoirRepository extends EntityRepository
{
	public function findForCompany($type, $company){
		...
		->leftJoin('App\Entity\CRM\DocumentPrix', 'f', 'WITH', 'f.id = a.facture')
		->leftJoin('App\Entity\CRM\Compte', 'c1', 'WITH', 'c1.id = f.compte')
		->leftJoin('App\Entity\Compta\Depense', 'd', 'WITH', 'd.id = a.depense')
		->leftJoin('App\Entity\CRM\Compte', 'c2', 'WITH', 'c2.id = d.compte')
	...
	public function custom_count($company, $type){
