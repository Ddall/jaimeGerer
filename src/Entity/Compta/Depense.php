 ...
 * @ORM\Entity(repositoryClass="App\Entity\Compta\DepenseRepository")
 * @UniqueEntity(
...
class Depense
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\CRM\Compte", inversedBy="depenses")
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Compta\LigneDepense", mappedBy="depense", cascade={"persist", "remove"}, orphanRemoval=true)
     */
    private $lignes;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Compta\Rapprochement", mappedBy="depense")
     */
    private $rapprochements;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Compta\Avoir", mappedBy="depense")
     */
    private $avoirs;
	...
	/**
	 * @ORM\ManyToOne(targetEntity="App\Entity\NDF\NoteFrais", inversedBy="depenses")
	 * @ORM\JoinColumn(nullable=true, onDelete="CASCADE")
	 */
	private $noteFrais;

      /**
       * @ORM\OneToMany(targetEntity="App\Entity\Compta\JournalAchat", mappedBy="depense", cascade={"remove"}, orphanRemoval=true)
       */
    ...
    */
    ...
    /**
    * @ORM\OneToMany(targetEntity="App\Entity\Compta\DepenseSousTraitance", mappedBy="depense")
    */
  ...
  public function getUserEdition()
  {
	 ...
	 * Add lignes
	 *
	 * @param \App:Compta\LigneDepense $ligne
	 * @return Depense
	 */
	public function addLigne(\App\Entity\Compta\LigneDepense $ligne)
	{
	 ...
	 * @param \App:Compta\LigneDepense ligne
	 */
	public function removeLigne(\App\Entity\Compta\LigneDepense $ligne)
	{
     ...
     * @return Depense
     */
    public function addAvoir(\App\Entity\Compta\Avoir $avoirs)
    {
        $this->avoirs[] = $avoirs;
     ...
     * Add sousTraitances
     *
     * @param \App\Entity\Compta\DepenseSousTraitance $sousTraitances
     * @return Depense
     */
    public function addSousTraitance(\App\Entity\Compta\DepenseSousTraitance $sousTraitances)
    {
     ...
     * @param \App\Entity\Compta\DepenseSousTraitance $sousTraitances
     */
    public function removeSousTraitance(\App\Entity\Compta\DepenseSousTraitance $sousTraitances)
    {
