 ...
 * @ORM\Entity(repositoryClass="App\Entity\Compta\OperationDiverseRepository")
 */
class OperationDiverse
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Compta\CompteComptable", inversedBy="operationsDiverses")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\NDF\NoteFrais", cascade={ "persist"})
     * @ORM\JoinColumn(nullable=true, unique=false)
     */
    private $noteFrais;
