 ...
 * @ORM\Entity(repositoryClass="App\Entity\Compta\JournalVenteRepository")
 */
class JournalVente
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\CRM\DocumentPrix", cascade={ "persist"}, inversedBy="journalVentes")
     * @ORM\JoinColumn(nullable=true, unique=false)
     */
    private $facture;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Compta\Avoir", cascade={"persist"}, inversedBy="journalVentes")
     * @ORM\JoinColumn(nullable=true, unique=false)
     */
    private $avoir;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Compta\CompteComptable", inversedBy="journalVentes")
