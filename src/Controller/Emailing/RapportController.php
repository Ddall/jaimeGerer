...
use App\Form\Emailing\RapportListeContactType;
...
{	
	 ...
	 */
	public function rapportAjouterAction(Request $request, $type)
	{
		$rapport = new Rapport();
		$form = $this->createForm(RapportListeContactType::class, $rapport)
		...
		//~ $form->remove('nom');
		//~ $form->add('nom', \Symfony\Component\Form\Extension\Core\Type\TextType::class, array(
 ...
 //~ var_dump($arr_obj); exit;
	...
	public function rapportEditerAction(Request $request, Rapport $rapport)
	{
		...
		//~ $form->add('nom', \Symfony\Component\Form\Extension\Core\Type\TextType::class, array(
						...
						//~ )
					//~ ));
		$form->add('filters', CollectionType::class, array(
                'entry_type' => RapportFilterType::class,
                'entry_options' => array(
                    'type' => $type
                ),
	 ...
	 */
	public function rapportEnregistrerAction(Request $request)
	{
		//~ echo "<pre>";
		//~ print_r($arr_data);
		//~ echo "\n";
