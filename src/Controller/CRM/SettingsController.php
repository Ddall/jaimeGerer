...
// 	}
	 ...
	 */
	public function settingsCompleterAction(Request $requestData, Settings $settings){
	 ...
	 */
	public function settingsCompleterCCAction(Request $requestData, Settings $settings){
		$response = new Response();
	 ...
	 */
	public function settingsListeAjouterAction(Request $requestData){
	 ...
	 */
	public function settingsImageUploadAction(Request $requestData){
		$em = $this->getDoctrine()->getManager();
