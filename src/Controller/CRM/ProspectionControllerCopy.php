...
use App\Form\CRM\ContactFromProspectionType;
use App\Form\CRM\ProspectionType;
use App\Form\CRM\RapportFilterType;
use App\Form\CRM\RapportType;
use App\Util\DependancyInjectionTrait\ProspectionServiceTrait;
...
class ProspectionControllerCopy extends Controller
{
     ...
     */
    public function prospectionListeAjaxAction(Request $requestData)
    {
        ...
        $repository = $this->getDoctrine()->getManager()->getRepository('App:CRM\Prospection');
        $repositoryInfo = $this->getDoctrine()->getManager()->getRepository('App:CRM\ProspectionInfos');
    ...
    public function changeListTitle($id,Request $request)
    {
        ...
        $prospection = $repo->getRepository('App:CRM\Prospection')->find($id);
     ...
     */
    public function prospectionSupprimerAction(Request $request, Prospection $prospection)
    {
     ...
     */
    public function prospectionAjouterAction(Request $request)
    {
        $prospection = new Prospection();

        $form = $this->createForm(
            ProspectionType::class,
            $prospection
        );
     ...
     */
    public function prospectionRapportEnregistrerAction(Request $request, Prospection $prospection)
    {

        $data = json_decode($request->request->get('data'), true);

        $responseDelete  = $this->prospectionService->checkProspectDeleted($data,$prospection);
        $responseList = $this->prospectionService->checkIfProspectList($data, $this->getUser(), $prospection);
     ...
     */
    public function prospectionRapportAjouterAction(Request $request, Prospection $prospection)
    {
        $em = $this->getDoctrine()->getManager();
        $filterRepo = $em->getRepository('App:CRM\RapportFilter');
        $contactRepo =  $em->getRepository('App:CRM\Contact');
        $prospectionInfosRepo =  $em->getRepository('App:CRM\ProspectionInfos');
        ...
        if ($form->isSubmitted()) {
            ...
            $this->prospectionService->addProspectionContacts($newProspects, $this->getUser(), $prospection);
     ...
     */
    public function prospectionRapportRowMajAction(Request $request, Prospection $prospection)
    {
        $data = $request->request->get('data');
        $em = $this->getDoctrine()->getManager();

        $contactRepo = $this->getDoctrine()->getManager()->getRepository('App:CRM\Contact');
        $prospectionInfosRepo = $this->getDoctrine()->getManager()->getRepository('App:CRM\ProspectionInfos');
    ...
    public function prospectionPhoningAction(Prospection $prospection)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $prospectionInfosRepo =  $em->getRepository('App:CRM\ProspectionInfos');
        $prisecontactRepo = $em->getRepository('App:CRM\PriseContact');
     ...
     */
    public function prospectionRapportMajRowRapportAction( Request $request, Prospection $prospection)
    {
        $em = $this->getDoctrine()->getManager();
        $contactRepo = $em->getRepository('App:CRM\Contact');
        $infoRepo = $em->getRepository('App:CRM\ProspectionInfos');
     ...
     */
    public function prospectionRapportSaveNotes(Request $request)
    {
     ...
     */
    public function prospectionAjouterContactAction(Request $request, Contact $contact)
    {
        $em = $this->getDoctrine()->getManager();
        $prospectionInfosRepo =  $em->getRepository('App:CRM\ProspectionInfos');
        ...
        $form = $this->createForm(ContactFromProspectionType::class, $contact, array(
     ...
     */
    public function prospectionNbreAffichageAction(Request $request, Prospection $prospection)
    {
    ...
    public function changeRapports(Request $request)
    {
        ...
        //enregistrement des contacts comme etant des prospects
        $this->prospectionService->checkIfProspectList($newData, $this->getUser(), $prospection);
