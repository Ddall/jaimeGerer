...
use App\Form\Compta\OperationDiverseType;
use App\Service\NumService;
use Symfony\Bundle\FrameworkBundle\Controller\AbstractController;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\Routing\Annotation\Route;

class CompteAttenteController extends AbstractController
{
	/**
	 ...
	 */
	public function compteAttenteCorrigerAction(Request $request, NumService $numService, $id, $codeJournal){

		//creation du formulaire
		$od =  new OperationDiverse();
		$form = $this->createForm(OperationDiverseType::class, $od, array(
