...
use App\Entity\Compta\JournalVente;
...
class JournalVentesController extends AbstractController
{

    use NumServiceTrait;
	/**
	 * @Route(path="/compta/journal-ventes",
	...
	// 	$journalVentesService = $$this->get('appbundle.compta_journal_ventes_controller');
